...
import fundacaoJornadaOriginal from "@images/fundacao-jornada-usuario-original.png"
import fundacaoJornadaFinal from "@images/fundacao-jornada-usuario-final.png"
...
<Image src={fundacaoJornadaOriginal} alt="Mapa da jornada do usuário original."   widths={[320, 480, 768, 1104, 1650, 1920]}
  class="card__picture--image"
  loading="lazy"
  decoding="async"
  formats={["webp", "jpg"]}
...
<Image src={fundacaoJornadaFinal} alt="Mapa da jornada do usuário final."   widths={[320, 480, 768, 1104, 1650, 1920]}
  class="card__picture--image"
  loading="lazy"
  decoding="async"
  formats={["webp", "jpg"]}
