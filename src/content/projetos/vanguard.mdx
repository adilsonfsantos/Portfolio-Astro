...
description: >-
  Conheça como foi o processo de criação do site e aplicativo para a Vanguard. Construtora e incorporadora que busca valorizar a experiência de morar.
categories:
  - UI Design
roles:
  - UI Designer
...
<Picture
  src={VanguardGuide}
  alt="Guia de estilos demonstrando as cores e tipografia utilizadas no site dea Vanguard." layout="popout"
/>

<Picture
  src={VanguardSiteHome}
  alt="Detalhe da página home demonstra uma parte do layout da página home." layout="full-width"
/>

<Picture
  src={VanguardSiteEmpreendimento}
  alt="Trecho da página de empreendimentos com informações sobre o imóvel." layout="full-width"
/>

<Picture
  src={VanguardSiteEmpreendimento2}
  alt="Diversos detalhes da página de empreendimentos." layout="full-width"
/>

<Picture
  src={VanguardAppFluxo}
  alt="Diversas telas do aplicativo da Vanguard." layout="full-width"
/>
