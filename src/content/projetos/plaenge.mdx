...
<Image src={plaengeGuide} alt="Fontes e paleta de cores do layout."   widths={[320, 480, 768, 1104, 1650, 1920]}
...
<Image src={plaengeFull} alt="Imagem da home."   widths={[320, 480, 768, 1104, 1650, 1920]}
  class="card__picture--image"
  loading="lazy"
  decoding="async"
  formats={["webp", "jpg"]}
...
<Image src={plaengeOutro} alt="Diversas telas do app."   widths={[320, 480, 768, 1104, 1650, 1920]}
  class="card__picture--image"
  loading="lazy"
  decoding="async"
  formats={["webp", "jpg"]}
