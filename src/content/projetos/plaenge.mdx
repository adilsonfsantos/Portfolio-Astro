...
<Picture src={plaengeSiteEmpreendimento} alt="Detalhe da página empreendimentos do site." />

<Picture src={plaengeSiteAplaenge} alt="Trecho da página do site sobre a Plaenge." />

<Picture src={plaengeAppHome} alt="Detalhe da home e outras telas do aplicativo." />

<Picture src={PlaengeAppOutro} alt="Detalhes de outras telas do aplicativo." />

<Picture src={plaengeSitePVC} alt="Design da página home do portal do cliente." />

<Picture src={plaengeSitePVC2} alt="Detalhe de diversas páginas do portal do cliente." />
