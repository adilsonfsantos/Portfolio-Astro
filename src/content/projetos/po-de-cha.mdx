...
<Picture src={podechaGuide} alt="Imagem demonstra uma parte do layout da página sobre a história da Sagrado."/>
...
<Picture src={podechaHome} alt="Imagem demonstra uma parte do layout da página sobre a história da Sagrado."/>

<Picture src={podechaParceiro} alt="Imagem demonstra uma parte do layout da página sobre a história da Sagrado."/>

<Picture src={podechaReceita} alt="Imagem demonstra uma parte do layout da página sobre a história da Sagrado."/>
