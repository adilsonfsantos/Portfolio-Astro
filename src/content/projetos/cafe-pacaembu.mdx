...
<Image src={pacaembuIndependencia} alt="Stories e post da receita que ensina a fazer um café com suco de laranja."   widths={[320, 480, 768, 1104, 1650, 1920]}
...
<Image src={pacaembuReceita} alt="Stories e post para a comemoração da independência do Brasil na imagem tem um copo de café sobre um fundo amarelo com o texto o jeitinho brasileiro de fazer café."   widths={[320, 480, 768, 1104, 1650, 1920]}
  class="card__picture--image"
  loading="lazy"
  decoding="async"
  formats={["webp", "jpg"]}
